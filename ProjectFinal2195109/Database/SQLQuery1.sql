...
create table Ingrediant(
	...
	IngrediantMeasurementUnit varchar(50) not null,
	RecipeID int FOREIGN KEY REFERENCES Recipe(RecipeID) ON DELETE CASCADE,
);
...
create table List_Item(
	...
	IngrediantID int FOREIGN KEY REFERENCES Ingrediant(IngrediantID) ON DELETE CASCADE,
	RecipeID int FOREIGN KEY REFERENCES Recipe(RecipeID) ON DELETE CASCADE,
);
...
create index idx_RecipeID on List_Item (RecipeID);